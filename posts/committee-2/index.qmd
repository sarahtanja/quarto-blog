...
Jackie met with Francesco Saliu on 21NOV2023 and they spoke about using plastics from his studies in which he has already characterized PVC leachate 'chemical cocktail' and the associated phthalates. This would look like getting Francesco to send us
:::

## 6. Redo with Aiptasia model organism

| Pros                                                                                                      | Cons                                         |
|------------------------------------------|----------------------|
| model organism for coral                                                                                  | they're mostly clones                        |
| could keep and manipulate at UW                                                                           | it's kind of already been done [@klein2021a] |
| fully annotated genome [**Exaiptasia diaphana**](https://www.ncbi.nlm.nih.gov/datasets/taxonomy/2652724/) |                                              |

## 7. Redo microbiome study with PNW crustose coralline algae (CCA)
