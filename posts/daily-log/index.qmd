...
-   qiime2R , R package for importing qza/qzv files: <https://forum.qiime2.org/t/tutorial-integrating-qiime2-and-r-for-data-visualization-and-analysis-using-qiime2r/4121>

-   Western Society of Naturalists (WSN) annual meeting, Nov 9th - 12th, Monterey, CA:

> We aim to open the WSN website for online registration and the submission of abstracts for contributed papers and posters in **August**. Registration for attendees will remain open up to and including the days that the meeting is held, although late registration fees will apply. However, abstract submissions will only be accepted through Monday September 29th, 2023, and as in past years, will be first come, first accepted. Late abstracts will not be accepted.
