...
-   Read Lohman et al 2016 doi: 10.1111/1755-0998.12529 on TagSeq at UT Austin GSAF

-   Got into a Jupyter Notebook and QIIME2 environment on raven server! Whoo! Did this from the school office, now we need to see if I can do it from my home network using Big IP Edge VPN Client

##### 03-AUG-2023

-   Received the RNA samples back from UTGSAF!

-   Discovered that the bioinformatics computer in lab 238 (jp-d20) no longer dual-boots to Linux and Windows... It only boots to Linux. This is a problem because the NanoDrop software only works on Windows. Sam White helped me figure that out via slack, and Jeremy helped me find a CD NanoDrop software install.

-   Attended Roberts Lab meeting

-   Selected 5 samples to run through the [Zymo OneStep PCR Inhibitor Removal Kit](https://www.zymoresearch.com/products/onestep-pcr-inhibitor-removal-kit) (of which I got the free kit sample) : 1-CA2a, 1-CH2a, 1-Ea, 1-PA2a, 1-PH1a

-   Ran those samples through the Roberts Lab NanoDrop! Read the manual found as a [pdf online here](https://assets.thermofisher.com/TFS-Assets/CAD/manuals/nd-1000-v3.8-users-manual-8%205x11.pdf)

-   Learned about NanoDrop from [this YouTube Video](https://toptipbio.com/the-nanodrop-results-explained/)

-   Sadly, the Zymo OneStep PCR Inhibitor Removal Kit didn't so the trick. All of the samples had good 260/280 ratios of around 1.9, indicating there isn't protein contamination. But... they ALL have low 260/230 ratios, indicating contamination by salts.
...
: Nanodrop 1000 results from 03AUG2023

-   So now we have to find a way to purify the RNA to target getting rid of salty contamination and inhibitors[^1].

[^1]: It might be phenols carried over from the RNA extraction ([paper here](https://www.sciencedirect.com/science/article/pii/S0003269718312545)), ([putnam lab issue here](https://kevinhwong1.github.io/KevinHWong_Notebook/20210121-Nanodrop-results-on-Tag-Seq-samples/)), ([roberts lab issue here](https://github.com/RobertsLab/resources/issues/1670))
