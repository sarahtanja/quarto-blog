...
2.  For each sample, arrange the following tubes in microcentrifuge tube racks:
    ...
    9.  [**Zymo Spin IC Column in a Collection Tube** *(RNA Clean & Concentrator-5)*]{style="background-color:#9f6"}

    10. [**nuclease-free tube for eluted RNA**]{style="background-color:#9f6"}

    11. [**Qubit assay tube for 1uL of eluted RNA**]{style="background-color:#9f6"}
