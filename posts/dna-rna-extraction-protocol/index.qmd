...
The samples I am working with are liquid-nitrogen snap-frozen \~3cm *Montipora capitata* coral fragments held at -80°C, in 1.5mL cryovials. They samples are fragments of coral that had been exposed to the multiple stressors of thermal stress and phthalate pollution in 20mL mesocosms for 48 hours.
...
::: {.callout-tip appearance="simple"}
Think about how many samples you can process at once, and your kit, centrifuge, and homogenizer capacity. You should also make sure to include a blank and a mock community with each batch of extractions.
:::
...
2.  For each sample, arrange the following 10 tubes in microcentrifuge tube racks:
    ...
    3.  [**nuclease-free tube**]{style="background-color:#993399"}

    4.  [**DNA Spin-Away Filter (yellow) in a Collection Tube**]{style="background-color:#ff0"}

    5.  [**Collection Tube**]{style="background-color:#ff0"}

    6.  [**FINAL nuclease-free tube for eluted DNA**]{style="background-color:#ff0"}

    7.  [**Qubit assay tube for** $1\mu L$ **of eluted DNA**]{style="background-color:#ff0"}

    8.  [**RNA Spin-Away Filter (green) in a Collection Tube**]{style="background-color:#9f6"}

    9.  [**FINAL nuclease-free tube for eluted RNA**]{style="background-color:#9f6"}

    10. [**Qubit assay tube for** $1\mu L$ **of eluted RNA**]{style="background-color:#9f6"}
...
-   Open the tube, and 'top-off' the sample with another 500uL of `DNA/RNA Shield`, bringing the total volume to 1000uL
...
Transfer the buffered supernatent (should be a total of 700uL, which can be passed through the filter in one go) to yellow **`Spin-Away Filter`** in a **`Collection Tube`** and centrifuge
...
-   The RNA+ethanol volume is now 1,400uL. In aliquots up to 700uL, transfer the RNA sample to the green **`Zymo-Spin IIICG Column`** in a **`Collection Tube`**, centrifuge, and discard the flow-through. This step binds the RNA to the green column filter. Repeat until all RNA Sample has passed through the filter.
...
-   Carefully transfer the column into the FINAL nuclease-free tube labelled for containing the eluted DNA/RNA end products

-   Add 70uL **`DNase/RNase-Free Water`** directly to the column matrix and centrifuge at 16,000xg for 30s

-   Place FINAL eluted DNA/RNA tubes on ice

-   Transfer 1uL of each eluted DNA/RNA sample to their respectively labelled Qubit assay tube, and keep on ice
...
## RNA Clean-up **WORK IN PROGRESS RESULTS UNKNOWN PROCEED WITH... EMBRACING FAILURE**
...
-   70ul of RNA in nuclease-free water
