...
-   label 15mL falcon tube with sampleID

-   add 5mL of `DNA/RNA Shield` to each labelled 15mL tube

-   transfer frozen anemone to labelled 15mL tube

-   thaw sample in `DNA/RNA Shield` on ice

-   once thawed, homogenize using a tissue-tearor for 30 seconds
...
-   refill symbiont pellet tube with `DNA/RNA Shield`
...
-   top off symbiont pellet with 1ml of `DNA/RNA Shield` // 3X[^5] [Phosphate-Buffered Saline (PBS)](https://www.sigmaaldrich.com/US/en/product/sigma/p7059?icid=sharepdp-clipboard-copy-productdetailpage)?
...
-   remove 1mL from the re-suspended symbiont tube, and place in a new labelled tube
