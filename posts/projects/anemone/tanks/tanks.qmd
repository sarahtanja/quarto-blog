...
Download the [Kessil App](https://kessil.com/products/app_wifi.php) [A360X Tuna Blue](https://kessil.com/products/saltwater_A360X.php) [WiFi Dongle](https://kessil.com/products/accessories_WifiDongle.php)

[Kessil WiFi app control user manual](https://kessil.com/downloads/accessories/kessilwifi_UserManual/wifi_user_manual.html)

Connect all 4 lights to each other in a daisy-chain using the `k-link` usb-c cords. There will be one light with an open k-link port. Plug a Kessil WiFi Dongle into the open k-link port.

The WiFi dongle will blink purple. In the Kessil App, select to connect `Through Wireless Router` where `Device can connect to internet & control AP9X/Dongle at the same time`and check the box that says `Apex Fusion control ONLY`.

The purple blinking light switched straight to green in this case, because it had been previously connected to the neptune Apex network.

Sign-in to Apex Fusion account, you'll notice you can control the on&off cycle of the lights through Apex!
