---
title: "Coral collections & tank acclimation"
...
```{r}
# Create zoomed-out inset map
inset_basemap <- get_map(location = c(lon = -158.0, lat = 21.0), zoom = 7)
inset_ggmap <- ggmap(inset_map)+
  theme_void()
...
library(ggplot2)
library(cowplot)
install.packages("ggplotify")  # Only once
library(ggplotify)
